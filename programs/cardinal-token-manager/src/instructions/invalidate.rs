...
use mpl_token_metadata::instructions::Unlock;
use mpl_token_metadata::instructions::UnlockInstructionArgs;
use mpl_token_metadata::types::TokenStandard;
use mpl_token_metadata::types::TransferArgs;
use mpl_token_metadata::types::UnlockArgs;
            ...
            match token_manager.kind {
                k if k == TokenManagerKind::Programmable as u8 => {
                    ...
                    invoke_signed(
                        ...
                        }.instruction(UnlockInstructionArgs {
                            unlock_args: UnlockArgs::V1 { authorization_data: None }
                        }),
                        &[
                            token_manager.to_account_info(),
                    ...
                    invoke_signed(
                        &MetadataTransfer {
                            token: ctx.accounts.recipient_token_account.key(),
                            token_owner: ctx.accounts.recipient_token_account.owner.key(),
