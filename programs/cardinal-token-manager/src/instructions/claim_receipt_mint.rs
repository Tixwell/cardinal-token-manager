...
pub fn handler(ctx: Context<ClaimReceiptMintCtx>, name: String) -> Result<()> {
    ...
    receipt_mint_manager.bump = ctx.bumps.receipt_mint_manager;
    ...
    invoke_signed(
        &CreateMetadataAccountV3 {
            ...
            data: DataV2 {
                ...
                uri: "https://api.cardinal.so/metadata/".to_string() + &ctx.accounts.token_manager.mint.to_string() + "?text=RENTED",
